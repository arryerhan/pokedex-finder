...
const hidePikachu = document.querySelector('.pikachu');
const showMainContainer = document.querySelector('.main-container');

setInterval(() => {
  hidePikachu.style.display = 'none'; 
  showMainContainer.classList.remove('hidden');
}, 1000);
